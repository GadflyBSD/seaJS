...
// ========================= Masonry ===============================
  ...
  //   https://github.com/jsor/jcarousel/blob/master/lib/jquery.jcarousel.js
	...
	$.fn.seaMasonry = function(options){
		var dom = this, config = {
		...
		$.seaBase.run(config, options, function(config){
			...
			if(config.infinitescroll){
				require.async('InfiniteScroll', function(){
					function successfullyLoadedCallback(newElements){
					...
					$(dom).seaInfiniteScroll(config, successfullyLoadedCallback);
				});
			}
		});
	}
